        ...
        <div v-if="isOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-10">
            <div class="w-96 bg-white flex flex-col gap-y-1 px-2 max-h-screen overflow-y-scroll">
                <div class="flex flex-row justify-between items-center border-b mb-4 p-4">
                    ...
                    <button type="button" class="text-black/50 hover:text-red-600 transition-colors ease"
                        @click="closeModal">
                ...
                <form @submit.prevent="createProduct" class="flex flex-col flex-grow min-h-0 gap-y-4 p-4" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input type="file" class="file-input file-input-bordered w-full" ref="file"
                            @change="uploadProductImage" />
                        <div v-if="src" class="w-full h-44 overflow-hidden relative">
                            <img :src="src" alt="image-product" class="w-full h-full object-cover">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input v-model="payload.price" id="price" type="number" class="input input-bordered w-full">
                    </div>
                    <div class="flex flex-col">
                        <label for="stock">Stock</label>
                        <input v-model="payload.stock" id="stock" type="number" class="input input-bordered w-full">
                    </div>
                    <div class="flex flex-col">
