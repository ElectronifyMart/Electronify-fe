    ...
    <div class="w-96 flex flex-col bg-slate-50 box-border overflow-auto">
        ...
        <div class="flex flex-col px-2 py-2 gap-2">
          <div class="flex flex-row items-center justify-between">
            ...
            <h1 class="font-semibold h-full flex items-center">
              {{ formatterRupiah.formatPriceToIDR(products.price) }}
            </h1>
          </div>
          <p class="text-sm text-end">
            Total price: {{ formatterRupiah.formatPriceToIDR(total_price) }}
          </p>
          <p class="text-sm">
      ...
      <div class="w-full box-border p-2 flex flex-col gap-2">
        ...
        <form
          ...
          class="w-full box-border flex flex-col gap-4"
        >
          <div class="flex flex-row gap-2">
            <div class="flex flex-col w-1/2">
              ...
              <input
                ...
                class="focus:outline-none h-10 rounded pl-2 w-full border"
                type="text"
                id="fname"
              />
            </div>
...
const close = (data = false) => {
  emits("close", data);
  (payload.quantity = 1), (payload.fname = "");
  payload.ltname = "";
  payload.address = "";
};
